...
class Database:
    ...
    #
    # IMPORTANT:
    # No created_at column is assumed.
    # ============================================================
    ...
    # 3. Delete Storage file if DB insert fails.
    # ============================================================
    ...
    #
    # This allows a user to see documents uploaded previously.
    # ============================================================
    ...
    #
    # Security:
    # User can only retrieve their own document.
    # ============================================================
    ...
    #
    # Deletes:
    # 1. Physical Supabase Storage file
