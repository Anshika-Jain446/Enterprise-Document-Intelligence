...
#
# No API key or URL is placed in app.py.
# GeminiModel is responsible for the actual web-search
        ...
        if results:
            ...
            with st.expander(
                ...
                for index, source in enumerate(
                    ...
                    # Show web result URL if the
                    # web-search provider returned one.
                    #
                    # This DOES NOT add a URL to your
                    # source code. It only displays the
                    # URL returned by the web-search
                    # implementation.
