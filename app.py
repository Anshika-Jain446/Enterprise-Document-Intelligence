...
if not st.session_state.messages:
    st.markdown(
        ...
        **Retrieval is a query-time decision.** It decides how stored chunks are searched when the user asks a question.
        ...
        pgvector is used for embedding-based semantic similarity. Hybrid retrieval combines semantic similarity with PostgreSQL full-text ranking. If embeddings are temporarily unavailable, the app falls back to the existing PostgreSQL text retrieval instead of removing the feature.
        """
    )