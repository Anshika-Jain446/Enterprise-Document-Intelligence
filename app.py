    ...
    for conversation in conversations:
        with st.container(border=True):
            ...
            with col2:
                if st.button(
                    "Open",
                    key=(f"open_conversation_" f"{conversation['id']}"),
                ):
            ...
            with col3:
                if st.button(
                    "Delete",
                    key=(f"delete_conversation_" f"{conversation['id']}"),
                ):
                ...
                with st.container(border=True):
                    ...
                    with col2:
                        ...
                        new_role = st.selectbox(
                            ...
                            key=(f"role_" f"{managed_user['id']}"),
                        )

                    with col3:
                        if st.button(
                            "Save role",
                            key=(f"save_role_" f"{managed_user['id']}"),
                        ):
                            try:
                    ...
                    with col4:
                        with st.popover("Reset password"):
                            new_password = st.text_input(
                                "New password",
                                type="password",
                                key=(f"password_" f"{managed_user['id']}"),
                            )

                            confirm_password = st.text_input(
                                "Confirm password",
                                type="password",
                                key=(f"confirm_password_" f"{managed_user['id']}"),
                            )

                            if st.button(
                                "Reset",
                                key=(f"reset_" f"{managed_user['id']}"),
                            ):
                                if not new_password:
                        ...
                        if st.button(
                            "Delete",
                            key=(f"delete_user_" f"{managed_user['id']}"),
                        ):
