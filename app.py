...
def initialize_state():
    ...
    defaults = {
        ...
        # Preserved configuration/session values.
        "selected_document_ids": [],
...
def generate_answer(
    ...
    try:
        ...
        # Backward compatibility with GeminiModel
        # implementations that only accept query/chunks.
        try:
