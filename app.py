...
with st.sidebar:
    ...
    if st.session_state.role == "Admin":
        ...
        with st.expander(
            ...
            st.write(
                "All registered users are stored in PostgreSQL."
            )
            ...
            try:
                ...
                st.error(
                    f"Unable to load users from PostgreSQL: {e}"
                )
...
st.info(
    ...
    "The system processes them together and preserves the "
    "original filename as the source of every chunk."
)
    ...
    for uploaded_file in uploaded_files:
        ...
        try:
            ...
            try:
                ...
                st.warning(
                    f"Document processed but could not be saved "
                    f"to PostgreSQL: {e}"
                )
