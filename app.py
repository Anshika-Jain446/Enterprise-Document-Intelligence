...
class PostgreSQLStore:
        ...
        if self.connection is not None:
            ...
            try:
                ...
                if self.connection.closed == 0:
                    ...
                    # Always recover an aborted transaction.
    ...
    def initialize(self):
        ...
        try:
            ...
            # Make sure username uniqueness exists.
            try:
            ...
            for column_name, definition in document_columns:
            ...
            # ==================================================
            # REPAIR DOCUMENT USER IDs
            # ==================================================
            #
            # Old versions may have documents with NULL user_id.
            # They cannot be attached to users safely.
            #
            # We leave them untouched rather than assigning them
            # to the wrong user.
            # ==================================================

            # Remove potentially broken old FK first.
            try:
            ...
            for column_name, definition in chunk_columns:
            ...
            # Remove potentially broken old FK.
            try:
            ...
            for column_name, definition in conversation_columns:
            ...
            for column_name, definition in message_columns:
            ...
            # ==================================================
            #
            # Add them only after ALL required columns exist.
            # Invalid old rows are cleaned only when possible.
            # ==================================================
