...
# )
#
# because one missing variable causes the entire Streamlit app
# to crash with ImportError.
#
# Instead, import config as a module and safely read values.
...
# Make sure extensions contain dots.
...
You can configure PostgreSQL using either:
